...
\caption{Partial counter-example to \Cref{lemma:cayley}. It is not a counter-example because (a) the edges $p_1p_2$ and $q_1q_2$ are not primitive and (b) the origin is a lattice point in the interior of both bands (but it is the only one). 
%
