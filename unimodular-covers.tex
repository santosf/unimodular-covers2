...
This not only implies \Cref{conj:Oda}\eqref{itm:mixedIDP} in dimension two but also, as we show in \Cref{sec:cayley}, \Cref{conj:Oda}\eqref{itm:smoothIDP} for $3$-dimensional smooth \emph{prismatoids}, polytopes whose vertices all lie in two parallel facets:
...
%By claim \ref{claim:r}, $s_2$ lies above the affine line $\langle t \rangle$. 
