...
Motivated by  \Cref{conj:Oda}\eqref{itm:mixedIDP}, we recall the following definitions:
...
In this language,  \Cref{conj:Oda}\eqref{itm:mixedIDP} can be rephrased as if $P$ is a weak Minkowski summand of $Q$ and $Q$ is smooth, then the pair $(P,Q)$ is IDP.
