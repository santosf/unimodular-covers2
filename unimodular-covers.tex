...
The last two claims can be summarized as saying that in the pictures $b$, $t$ and $r$ have positive slope.
...
\[
g([p_1, q_2])= g( [q_1, q_1+q_2-p_1]) +1r. 
\]

\begin{claim}
\label{claim:g}
$g(t_1) > g(t_2)$ and $g(b_1) > g(b_2)$ while $g(r_1) < g(r_2)$ (and $g(l_1) < g(l_2)$).
...
%By claim \ref{positive slopes}, $s_2$ lies above the affine line $\langle t \rangle$. 
