...
This not only implies \Cref{conj:Oda}(1) in dimension three, but also, as we show in \Cref{sec:cayley}, \Cref{conj:Oda}(2) for $3$-dimensional \emph{prismatoids}, polytopes whose vertices all lie in two parallel facets:
