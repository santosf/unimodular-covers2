...
Work of F. Santos is also supported by grants  MTM2017-83750-P/AEI/10.13039/501100011033 and PID2019-106188GB-I00/AEI/10.13039/501100011033 of the Spanish State Research Agency and by project CLaPPo (21.SI03.64658) of Universisdad de Cantabria and Banco Santander}
...
%\paco{did not find this in the google books version of \cite{Grunbaum}; found it in Postnikov-Reiner-Williams, Tsuchiya, a survey by Rekha Thomas, and other places. Perhaps we can leave it without reference} 
...
To date there are no known example of IDP $3$-polytopes without a unimodular cover. Recent work of Gubeladze~\cite{Gubeladze} shows that another class of IDP 3-polytopes has unimodular covers, lattice polytopes which are convex hulls of all lattice points inside an ellipsoid. It remains open in general whether the classes are distinct in dimension $3$. 
%Let us also mention the following recent results of Gubeladze~\cite{Gubeladze}.
%In part (2), a polytope $P$ is called \emph{very ample} if the vertex cone $\cone(P-v)$ is contained in the translation $P-v$, for every vertex $v$ of $P$.
